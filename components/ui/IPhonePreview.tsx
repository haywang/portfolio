    ...
    <div className={`flex flex-col items-center justify-center ${className}`}>
      ...
      >
        ...
        {deviceConfig.notchWidth > 0 && !hasDynamicIsland && (
          <div
            className="absolute top-0 left-1/2 z-10 -translate-x-1/2 rounded-b-3xl bg-black"
            style={{
        ...
        {hasDynamicIsland && (
          <div
            className="absolute top-2 left-1/2 z-20 -translate-x-1/2 rounded-full bg-black"
            style={{
              width: `${deviceConfig.notchWidth}px`,
              height: `${deviceConfig.notchHeight}px`
            }}
        ...
        {/* 状态栏 - 使用固定高度和背景色 */}
        <div className="absolute top-1 right-0 left-0 z-10 flex h-10 items-center justify-between bg-white px-6 text-xs text-black">
